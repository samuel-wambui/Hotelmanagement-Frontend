...
@Component({
  selector: 'app-leases-lookup',
  templateUrl: './leases-lookup.component.html',
  styleUrls: ['./leases-lookup.component.sass']
})
export class LeasesLookupComponent implements OnInit {
